...
- `quizzes` เก็บคำถามทั้งหมด
- `forEach` ประมวลผลทีละข้อ
- เปรียบเทียบคำตอบกับ index ที่ถูกต้อง
- `filter` ใช้นับจำนวนข้อที่ถูก
- if/else ใช้กำหนดเกรด
- `reduce` สรุปจำนวนถูก/ผิด
- แยกขั้นตอนชัดเจน: ข้อมูล → ประมวลผล → แสดงผล

---

## ✅ สรุป

ในไฟล์นี้แสดงผลลัพธ์และคำอธิบายการทำงานของ code ในแต่ละข้อ
และเป็นการนำความรู้เรื่องต่าง ๆ มารวมกัน เช่น
